...
function EnterpriseLayoutContent({ children, useSceneNavigation = false }: EnterpriseLayoutProps) {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Bootstrap Client Component */}
      <BootstrapClient />
      
      {/* Updated Main Navigation Header - No sidebar references */}
...
export function EnterpriseLayout({ children, useSceneNavigation = false }: EnterpriseLayoutProps) {
  return (
    <NavigationProvider>
      <EnterpriseLayoutContent useSceneNavigation={useSceneNavigation}>
        {children}
